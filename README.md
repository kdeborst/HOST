...
What should it be?	
An online social web application for locating, connecting and promoting (local) hosts 
...
Core Feature 1:	Cross-Platform – Community Connector	
...
Core Feature 2:	Event Registration Form, HOST® Event Details, Admin (Panel)	
...
Core Feature 3:	Event Search, Ranking & Filter Functionality	
...
Optional Feature 4:	HOST® Organiser: Full Access Control Over Own Event(s)
...
	At least 2 different UI pages and at least 3 different user input elements.
	At least 1 UI element is affected by the user’s input.
	After the user submits their input a decision is made on that input that can cause at least 2 different results.
	A user’s information is collected together in a single code structure.
	Support for UNICODE characters in all user text input.
	Date and time formats reflect the user’s local settings.
	At least one string is localisable.


TECHNOLOGIES: MERN FULL-STACK

Project Overview	
Approach	    	Rich Client Development
Core Script(s)		ECMAScript 6+ Syntax (JavaScript6)
IDEs/ SDKs	    	Visual Studio Code 2019
                	MongoDB Compass Community		Postman DE 7.1.1
...
Technologies/
Libraries	    	HTML 5.0, CSS 3 
                	Bootstrap 4.0
                	RESTful Web API (CRUD)
                	Font Awesome 5.0
                	Geolocation
                	Webservices		Async/ Await
                	React Hooks
                	JSON Web Tokens
